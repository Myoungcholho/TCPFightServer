...
/* 메소드 */
bool PacketProc(Player* player, BYTE byPacketType, char* pPacket);
bool netPacketProc_MoveStart(Player* player, char* pPacket);
bool netPacketProc_MoveStop(Player* player, char* pPacket);
bool netPacketProc_Attack1(Player* player, char* pPacket);
bool netPacketProc_Attack2(Player* player, char* pPacket);
bool netPacketProc_Attack3(Player* player, char* pPacket);
